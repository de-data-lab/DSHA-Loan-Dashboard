...
export default function AgeofApplicationChart() {
  const [option, setOption] = useState<EChartsOption>({
    title: {
      text: "Age of Application",
      left: "center",
      textStyle: {
        color: "#111111",
        fontSize: 16,
    ...
    xAxis: {
      ...
      axisLabel: { color: "#222", fontSize: 12, rotate: 0 },
      name: "Age",
      nameLocation: "middle",
      nameGap: 30,
      nameTextStyle: { color: "#0c0b0b", fontSize: 14, fontWeight: 500, padding: [18, 0, 0, 0] },
    },
    yAxis: {
      type: "value",
      axisLine: { lineStyle: { color: "#bbb" } },
      ...
      nameLocation: "middle",
      nameGap: 40,
      nameTextStyle: { color: "#0c0b0b", fontSize: 14, fontWeight: 500, padding: [0, 0, 25, 0] },
    ...
    const loadLoanJSONData = async () => {
      try {
        ...
        filteredLoanData.forEach((item: any) => {
          const type = item.AGE_AT_APPLICATION;
          if (type) {
